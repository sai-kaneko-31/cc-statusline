...
//
// The Ambiguous code points the layout draws itself — the bar's █ and ░, the
// ahead/behind arrows, the truncation ellipsis — are not in this table, so they
// count as one cell. A terminal setting that widens the whole Ambiguous class
// draws them two and the lines run longer than the arithmetic reserved.
//
// The table is not limited to the private use areas, though. The emoji block
